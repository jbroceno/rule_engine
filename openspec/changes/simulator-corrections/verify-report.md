...
| RF-003 Tipos de alta | 2 opciones: CAPTACION, NOVACION | init HTML select static check | COMPLIANT |
| RF-003 Tipos de alta | tipoAlta=NOVACION no genera rechazo | offer_scenarios.test.js > TC-A1 | COMPLIANT |
...
|-------------|--------|-------|
| rules.json: Reglas con primeraViviendaHabitual EQ 0 | IMPLEMENTED | 5 occurrences grep confirmed |
...
| init HTML: select con 2 opciones correctas | IMPLEMENTED | Confirmed lines 37-40 |
| init TS: defaults finalidad=1, tipoAlta=NOVACION | IMPLEMENTED | Lines 45,47 |

...
Given un solicitante con primeraViviendaHabitual = 1
  And el resto de campos cumplen las condiciones de una oferta distinta de FIDELIZACION
...
- El parámetro `TIPO_ALTA_ADMITIDAS` del seed SQL contiene `["CAPTACION","NOVACION"]` 
...
When se ejecuta initcheck() contra una oferta diferente a FIDELIZACION sembrada con TIPO_ALTA_ADMITIDAS = ["CAPTACION","NOVACION"]
